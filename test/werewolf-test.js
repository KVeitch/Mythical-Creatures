...
var Werewolf = require('../exercises/08-werewolf');
...
describe('Werewolf', function() {
  ...
  it('should show what form its in', function() {
    ...
    assert.equal(werewolf.wolf, false);
    werewolf.change();
    assert.equal(werewolf.form, 'werewolf');
    werewolf.change();
    assert.equal(werewolf.form, 'human');
  });
  ...
  it('should start off not hungry', function() {
    // your code here
    var werewolf = new Werewolf('Billy', 'Tower');
  ...
  it('should be able to eat(victim) once hungry', function() {
    // your code here
    var victim = new Victim('Johnny',)
    var werewolf = new Werewolf('Billy', 'Tower');
    assert.equal(werewolf.eat(victim), "No thanks, I don't eat people yet!");
